					...
					<li>
						...
						{if isset($maintenance_mode) && $maintenance_mode == true}
							<span class="maintenance-mode">
								...
								title="<p class='text-left text-nowrap'><strong>{l s='Your shop is in maintenance.'}</strong></p><p class='text-left'>Your visitors and customers cannot access your shop while in maintenance mode.<br />To manage the maintenance settings, go to Preferences > Maintenance.</p>">{l s='Maintenance mode'}</span>
							</span>
						{/if}
					</li>
{/if}
